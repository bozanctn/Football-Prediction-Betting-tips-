...
# Veri setini yükleme
data = pd.read_csv("Germany\Bundesliga.csv")
...
team_name_to_id = {
    "Augsburg": 0, "Hertha": 1, "Union Berlin": 2, "Bielefeld": 3, "Werder Bremen": 4,
    "Dortmund": 5, "Ein Frankfurt": 6, "Freiburg": 7, "Hoffenheim": 8, "FC Koln": 9,
    "RB Leipzig": 10, "Leverkusen": 11, "Mainz": 12, "Mgladbach": 13, "Bayern Munich": 14,
    "Schalke 04": 15, "Stuttgart": 16, "Wolfsburg": 17, "Greuther Furth": 18,
    "Darmstadt": 19, "Heidenheim": 20, "Bochum": 21, "St Pauli": 22, "Holstein Kiel": 23
}
