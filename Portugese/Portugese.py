...
# Veri setini yükleme
data = pd.read_csv("Portugese\Portugese.csv")

data['Date'] = pd.to_datetime(data['Date'], format='%d/%m/%Y')

# Toplam gol sayısını hesaplama
...
team_name_to_id = {
    "Belenenses": 0, "Benfica": 1, "Boavista": 2, "Sp Braga": 3, "Famalicao": 4,
    "Farense": 5, "Gil Vicente": 6, "Maritimo": 7, "Nacional": 8, "Moreirense": 9,
    "Pacos Ferreira": 10, "Portimonense": 11, "Porto": 12, "Rio Ave": 13, "Santa Clara": 14,
    "Sporting CP": 15, "Tondela": 16, "Guimaraes": 17, "Estoril": 18, "Vizela": 19,
    "Arouca": 20, "Casa Pia": 21, "Chaves": 22, "Empoli": 23, "Salernitana": 24, "Venezia": 25, "Lecce" : 26, "Estrela" : 27, "Sp Lisbon" : 28, "AVS" : 29 # Add all relevant team mappings here
}
...
# Yeni özellikleri ekleme fonksiyonu
...
# Yeni özellikleri ekleyen fonksiyonun kullanılması.
...
# Eğitim ve test setlerini oluştuma
...
# Modelin performansını değerlendirme(Bu kısımda performansı görmek için kodda hesaplamaları yazdıracak değişiklikler yapmalısınız.)
