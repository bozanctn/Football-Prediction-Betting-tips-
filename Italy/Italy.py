...
# Veri setini yükleme
data = pd.read_csv("Italy\Italy.csv")
...
team_name_to_id = {
    "Atalanta": 0, "Bologna": 1, "Brescia": 2, "Cagliari": 3, "Fiorentina": 4,
    "Genoa": 5, "Verona": 6, "Inter": 7, "Juventus": 8, "Lazio": 9,
    "Lecce": 10, "Milan": 11, "Napoli": 12, "Parma": 13, "Roma": 14,
    "Sampdoria": 15, "Sassuolo": 16, "Spal": 17, "Torino": 18, "Udinese": 19,
    "Benevento": 20, "Spezia": 21, "Crotone": 22, "Empoli": 23, "Salernitana": 24, "Venezia": 25, "Lecce" : 26, "Cremonese": 27, "Monza": 28, "Frosinone": 29, "Como": 30 # Add all relevant team mappings here
}
...
# Yeni özellikleri eklemek için olan fonksiyonun kullanımı.
