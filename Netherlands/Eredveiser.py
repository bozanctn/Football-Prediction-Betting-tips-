...
# Veri setini yükleme
data = pd.read_csv("Netherlands\Eredveiser.csv")
...
team_name_to_id = {
    "Den Haag": 0, "Ajax": 1, "AZ Alkmaar": 2, "FC Emmen": 3, "Feyenoord": 4,
    "For Sittard": 5, "Groningen": 6, "Heerenveen": 7, "Heracles": 8, "Zwolle": 9,
    "PSV Eindhoven": 10, "Waalwijk": 11, "Sparta Rotterdam": 12, "Twente": 13, "Utrecht": 14,
    "Vitesse": 15, "VVV Venlo": 16, "Willem II": 17, "Nijmegen": 18, "Go Ahead Eagles": 19,
    "Volendam": 20, "Excelsior": 21, "Almere City": 22, "Willem II": 23, "Groningen": 24, "NAC Breda": 22 # Add all relevant team mappings here
}
